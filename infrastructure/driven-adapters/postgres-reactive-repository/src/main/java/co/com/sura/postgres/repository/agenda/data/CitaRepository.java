...
public interface CitaRepository extends ReactiveCrudRepository<CitaData,String> {
    ...
    Mono<Boolean>validarEstadosCitasToEgreso(String idRemision, Integer idEstadoConfirmada, Integer idEstadoProgreso);
    ...
    Mono<Boolean> cancelarCitasForEgreso(
    ...
    @Query("SELECT * FROM citas " +
            ...
            "LIMIT 1; ")
    Mono<CitaData> findCitaMasCercanaAnterior(LocalDateTime fechaCita, String idCita,
    ...
    @Query("SELECT * FROM citas " +
            ...
            "LIMIT 1; ")
    Mono<CitaData> findCitaMasCercanaPosterior(LocalDateTime fechaCita, String idCita,
                                               Integer idHorarioTurno, String idRegional, String idProfesional);
